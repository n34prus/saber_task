...
#include "CpCombatSubsystem.generated.h"
...
UCLASS()
class COMBAT_API UCpCombatSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()

public:

	static inline UCpCombatSubsystem* Get(UObject* WorldContextObject)
	{
		...
		return GI->GetSubsystem<UCpCombatSubsystem>();
	}
	...
	float ApplyCombatDamage(AActor* DamageCauser, AActor* Target, const FCombatDamagePacket& DamagePacket);
...
protected:
	...
	TMap<AActor*, UCpCombatHealthComponent*> CombatMembers;
